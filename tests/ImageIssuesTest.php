...
final class ImageIssuesTest extends TestCase {
	public function test_pagination_bounds_are_rejected(): void {
		$this->assertSame(400, Image_Issues::run(0, 20)->get_error_data()['status']);
		$this->assertSame(400, Image_Issues::run(1, 51)->get_error_data()['status']);
	}

	public function test_empty_collection_returns_items_and_pagination_shape(): void {
		$result = Image_Issues::run(1, 1);
