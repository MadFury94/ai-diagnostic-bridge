...
Implementation is tracked in [PLAN.md](PLAN.md). Version `0.1.1` includes the authenticated REST foundation and the WordPress admin credential-management screen.
